...
import br.com.happhour.async.ExceptionHandlingAsyncTaskExecutor;

/**
 * Configura um async para executar metodos asincronos.
 * 
 * @from jHipster
...
public class AsyncConfiguration implements AsyncConfigurer {
	...
	public AsyncConfiguration(ApplicationProperties appProperties) {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setThreadNamePrefix("testelocal-Executor-");
